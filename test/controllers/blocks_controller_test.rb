...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference("Block.count") do
      post blocks_url, params: { block: { building_id: @block.building_id, name: @block.name } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { building_id: @block.building_id, name: @block.name } }
