...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference("Charge.count") do
      post charges_url, params: { charge: { amount: @charge.amount, billing_id: @charge.billing_id, description: @charge.description, type: @charge.type } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { amount: @charge.amount, billing_id: @charge.billing_id, description: @charge.description, type: @charge.type } }
